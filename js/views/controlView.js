...
(function() {
  define(['jquery', 'underscore', 'backbone', 'handlebars', 'models/controls/switch', 'text!templates/control.html', 'views/editControlView'], function($, _, Backbone, Handlebars, SwitchModel, ControlTemplate, EditControlView) {
    var ControlView;
