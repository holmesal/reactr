...
(function() {
  define(['jquery', 'jqueryui', 'underscore', 'backbone', 'views/phoneView', 'handlebars', 'collections/phoneCollection', 'text!templates/editPane.html', 'models/controller', 'views/PrelaunchView'], function($, jqueryui, _, Backbone, PhoneView, Handlebars, PhoneCollection, EditPaneTemplate, ControllerModel, PrelaunchView) {
    var EditPaneView;
